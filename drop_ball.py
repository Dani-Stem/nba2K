...
class DropBall(pygame.sprite.Sprite):
    ...
    def __init__(self, pos, groups):
        ...
        self.ball_surf = pygame.image.load("tipoff/images/basketball.png").convert_alpha()
        ...
        self.is_dropped = False  # Track if the ball is still dropping

        self.player_sound = pygame.mixer.Sound("tipoff/images/sounds/player_success.wav")
        self.player_sound.set_volume(0.04)

        self.cpu_sound = pygame.mixer.Sound("tipoff/images/sounds/cpu_success.wav")
    ...
    def reset(self):
        ...
        self.is_dropped = False  # Ball is no longer dropped
